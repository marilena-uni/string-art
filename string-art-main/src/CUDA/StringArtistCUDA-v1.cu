...
//1 thread = 1 pixel
__global__ void drawLine_kernel(unsigned char* image, int currentPinId, int nextPinId, const float opacity, const PinPos* d_pins, size_t width, int scale)
{
